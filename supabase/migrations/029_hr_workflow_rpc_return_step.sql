-- RH-6J - RPC da workflow engine com suporte a return_step.
-- Mantem create_workflow, execute_step, approve_step e reject_step preservados e adiciona devolucao transacional de etapa.
...
begin
  ...
  if v_action is null or v_action not in ('create_workflow', 'execute_step', 'approve_step', 'reject_step', 'return_step') then
...
comment on function public.hr_workflow_apply_action(
  ...
  'Workflow engine transacional de RH. Nesta versao suporta create_workflow, execute_step, approve_step, reject_step e return_step; demais acoes retornam INVALID_ACTION.';
