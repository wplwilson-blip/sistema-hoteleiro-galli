-- RH-6K - RPC da workflow engine com suporte a cancel_workflow.
-- Mantem create_workflow, execute_step, approve_step, reject_step e return_step preservados e adiciona cancelamento transacional do workflow.
