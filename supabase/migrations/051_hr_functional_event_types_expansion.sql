-- RH-17C.1 - Expansao controlada dos tipos de eventos da Vida Funcional.
-- Amplia somente o check constraint de employee_functional_events.event_type.
-- Nao altera dados, colunas, RLS, policies, severidade, visibilidade ou status.
