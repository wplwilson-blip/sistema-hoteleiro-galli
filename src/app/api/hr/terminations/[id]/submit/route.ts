...
export async function POST(request: Request, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    const updated = await transitionEmployeeTermination({ context, termination, action: "submit" });
    ...
    return handleHrRouteError(error, "Nao foi possivel enviar desligamento para revisao.");
  }
}
