...
export async function POST(request: Request, { params }: RouteParams) {
  ...
  try {
    ...
    await publishEmployeeMovementFunctionalEvent({ context, previous: movement, movement: updated });
    ...
    return handleHrRouteError(error, "Nao foi possivel efetivar movimentacao funcional.");
  }
}
